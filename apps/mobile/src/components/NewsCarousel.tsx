                ...
                >
                  ...
                  >
                    <div className="p-5 sm:p-6 flex flex-col h-full">
                      ...
                      {/* Sentiment Indicator */}
                      <div className="mt-2 py-2 border-y border-stone-50 flex items-center justify-between">
                        <span className="text-[10px] font-medium text-stone-400 uppercase tracking-widest">Market Impact</span>
                        <div className="flex items-center gap-1.5">
                          <span className={`w-1.5 h-1.5 rounded-full ${
                            news.sentiment === 'Bullish' ? 'bg-green-500 animate-pulse' :
                            news.sentiment === 'Bearish' ? 'bg-red-500 animate-pulse' : 'bg-stone-300'
                          }`} />
                          <span className={`text-[10px] font-bold uppercase tracking-tighter ${
                            news.sentiment === 'Bullish' ? 'text-green-600' :
                            news.sentiment === 'Bearish' ? 'text-red-600' : 'text-stone-500'
                          }`}>
                            {news.sentiment}
                          </span>
                        </div>
